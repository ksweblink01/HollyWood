...
namespace HollyWood.Controllers
{
    public class TournamentsController : Controller
    {
        ...
        {
            var tournaments = db.Tournaments.Include(t => t.Event);
        ...
        {
            ViewBag.TournamentID = new SelectList(db.Events, "EventID", "EventName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "TournamentID,TournamentName")] Tournament tournament)
        {
            ...
            ViewBag.TournamentID = new SelectList(db.Events, "EventID", "EventName", tournament.TournamentID);
            return View(tournament);
        }
